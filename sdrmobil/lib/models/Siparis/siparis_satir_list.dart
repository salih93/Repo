...
List<SiparisSatirList> siparisSatirListFromJson(String str) =>
    List<SiparisSatirList>.from(
        json.decode(str).map((x) => SiparisSatirList.fromJson(x)));

String siparisSatirListToJson(List<SiparisSatirList> data) =>
    json.encode(List<dynamic>.from(data.map((x) => x.toJson())));

class SiparisSatirList {
  String malzemekodu;
  String malzemeadi;
  String grupadi1;
  String grupadi2;
 ...
 SiparisSatirList(
  ...
  SiparisSatirList.fromJson(Map<String, dynamic> json) {    
  ...
  Map<String, dynamic> toJson() {
    ...
    data['bedelsiz_kampanya_flag']=bedelsizkampanyaflag;
    data['yuzdesel_kampanya_flag']=yuzdeselkampanyaflag;
