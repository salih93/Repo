...
class MusteriMalAnaliziCardAy extends StatelessWidget {
  const MusteriMalAnaliziCardAy({ Key key, @required this.item, 
              this.index
            }) : super(key: key);
                      ...
                      Expanded(                      
                        child: Column(
                          ...
                          children: [
                            FittedBox(
                              fit: BoxFit.contain,
                              child: Text(item.malzemeKodu + " / " + item.malzemeAdi ,
                                style: TextStyle(fontSize: size.height * kMusteriMalDetayOran),),
                            )
                    ...
                    children: [
                      Expanded(
                        ...
                        child: Column(
                          ...
                          crossAxisAlignment: CrossAxisAlignment.start,
                          children: [
                            Text(item.ay1, style: TextStyle(fontSize: size.height * kMusteriMalDetayOran, fontWeight: FontWeight.bold),),
                          ],
                        ),
                      ),
                    ...
                    children: [
                      Expanded(
                        ...
                        child: Column(
                          ...
                          crossAxisAlignment: CrossAxisAlignment.start,
                          children: [
                            Text(item.ay2, style: TextStyle(fontSize: size.height * kMusteriMalDetayOran, fontWeight: FontWeight.bold),),
                          ],
                        ),
                      ),
                    ...
                    children: [
                      Expanded(
                        ...
                        child: Column(
                          ...
                          crossAxisAlignment: CrossAxisAlignment.start,
                          children: [
                            Text(item.ay3, style: TextStyle(fontSize: size.height * kMusteriMalDetayOran, fontWeight: FontWeight.bold),),
                          ],
                        ),
                      ),
                    ...
                    children: [
                      Expanded(
                        ...
                        child: Column(
                          ...
                          crossAxisAlignment: CrossAxisAlignment.start,
                          children: [
                            Text("Total", style: TextStyle(fontSize: size.height * kMusteriMalDetayOran, fontWeight: FontWeight.bold),),
                          ],
                        ),
                      ),
