...
class BekleyenSiparisUrunCard extends StatelessWidget {
  const BekleyenSiparisUrunCard({ Key key, @required this.item, this.index}) : super(key: key);
                              ...
                              children: [                              
                                            ...
                                            child:Column(children: [
                                              FittedBox(
                                                  ...
                                                  child: Text(item.miktar.toStringAsFixed(0), 
                                                    style: TextStyle(color: Colors.blue[800], fontSize: size.height * ksiparisoran),
                                ...
                                Expanded(flex: 2,                                
                                  child: Column(
                                    ...
                                    children: [
                                      Wrap(children: [
                                        Text("Birim:", style: TextStyle(fontSize: size.height * ksiparisoran),),
                                        Text(item.birimi, 
                                                style: TextStyle(color: Colors.blue[800], fontSize: size.height * ksiparisoran),
                                                textAlign: TextAlign.end,),
                                      ],),                                  
                                        ...
                                        children: [
                                          ...
                                          Expanded(flex: 1,          
                                            child:Column(children: [
                                              FittedBox(
                                                fit: BoxFit.contain,
                                                child: Text(mFormat.format(item.birimfiyat)+' '+format.currencySymbol, style: TextStyle(color: Colors.blue[800], fontSize: size.height * ksiparisoran),
                                                  textAlign: TextAlign.end,),
                                              ),
                                              ],
                                            ), 
                            ...
                            Row(children: [
                                        ...
                                        children: [
                                          ...
                                          Expanded(flex: 2,          
                                            child:Column(children: [
                                                FittedBox(
                                                  fit: BoxFit.cover,
                                                  child: Text(mFormat.format(item.tutar)+' '+format.currencySymbol, style: TextStyle(color: Colors.blue[800], fontSize: size.height * ksiparisoran),),
                                                ),
                                              ],
                                            ), 
                                          ),
                              ...
                              Expanded(flex: 2,                                
                                  child: Column(
                                    ...
                                    children: [
                                      Wrap(children: [
                                        Text("Kdv :", style: TextStyle(fontSize: size.height * ksiparisoran),),
                                        Text('%' + mFormat.format(item.kdvorani), style: TextStyle(color: Colors.blue[800], fontSize: size.height * ksiparisoran),),
                                      ],
                                      ),                                                                 
                                    ],
                                  ),
                                          ...
                                          Expanded(flex: 2,          
                                            child:Column(
                                              ...
                                              children: [
                                                FittedBox(
                                                  fit: BoxFit.contain,
                                                  child:Text(mFormat.format(item.satirtutari) + ' '+format.currencySymbol, style: TextStyle(color: Colors.blue[800], fontSize: size.height * ksiparisoran),),
                                                ),
